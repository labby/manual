...
if((!function_exists('register_frontend_modfiles') || !defined('MOD_FRONTEND_CSS_REGISTERED')) &&  file_exists(WB_PATH .'/modules/manual/frontend.css')) {
   echo '<style type="text/css">';
   include(WB_PATH .'/modules/manual/frontend.css');
   echo "\n</style>\n";
} 
